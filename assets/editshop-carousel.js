(()=>{
  ...
  const stories=[
    ...
    {slug:"pension",num:"010",meta:"국민연금과 노후",title:"국민연금, 사기라던데? 그래서 저는 돌려받을 수 있나요?",image:"/pension/images/hero-coin-mound.png",alt:"「국민연금」이라 적히고 금이 간 뒤 반창고가 붙은 돼지저금통, 뒤로 노을 진 서울 스카이라인"}
  ];
  const start=()=>{
