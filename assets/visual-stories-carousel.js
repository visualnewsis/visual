(()=>{
  ...
  const stories=[
    ...
    {slug:"pension",num:"013",meta:"국민연금 · 노후 · 인터랙티브",title:"국민연금 믿어도 돼? 그래서 돌려받을 수 있긴 하나요?",image:"/pension/images/hero-coin-mound.png",alt:"「국민연금」이라 적히고 금이 간 뒤 반창고가 붙은 돼지저금통, 뒤로 노을 진 서울 스카이라인"}
  ];
  const mount=host=>{
